        ...
        public void Ajouter(Commande laCommande)
        {
            using (SqlConnection connection = new SqlConnection())
            {
                ...
                using (SqlCommand command = connection.CreateCommand())
                {
                    ...
                    "(UtilisateurId, DateCommande, DateLivraison, ModeLivraison, AdresseId, PrixTotal) " +
                    "VALUES " +
                   $"('{laCommande.UtilisateurId}','{stringDateCommande}','{stringDateLivraison}','{laCommande.ModeLivraison}','{laCommande.AdresseId}','{strPrixTotal}')";
